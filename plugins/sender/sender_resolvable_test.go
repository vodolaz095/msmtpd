...
var errNotResolvable = fmt.Errorf(`421 "Seems like i cannot find your sender address mail servers using DNS, please, try again later"`)
...
func TestSenderIsResolvableDefault(t *testing.T) {
	...
	testCases["info@yandex.ru"] = nil
	testCases["info@example.org"] = errNotResolvable
	testCases["info@localhost"] = errNotResolvable

	// it should fail, becase A/AAAA Fallback delivery is disabled from the box
	testCases["info@mx.yandex.ru"] = errNotResolvable
	...
	testCases["somebody@feedback.vodolaz095.ru"] = errNotResolvable
	testCases["somebody@ivory.vodolaz095.ru"] = errNotResolvable
