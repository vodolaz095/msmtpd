...
var testErr = fmt.Errorf("521 I'm sorry, but recipient's email address is not in whitelist")
...
func TestAcceptMailFromDomainsOrAddresses(t *testing.T) {
	...
	cases["d@gmail.com"] = testErr
	cases["e@gmail.com"] = testErr
	cases["info@yandex.ru"] = testErr
...
func TestAcceptMailFromDomains(t *testing.T) {
	...
	cases["a@gmail.com"] = testErr
	cases["b@gmail.com"] = testErr
	cases["d@gmail.com"] = testErr
	cases["e@gmail.com"] = testErr
	cases["info@yandex.ru"] = testErr
...
func TestAcceptMailFromAddresses(t *testing.T) {
	...
	cases["a@example.org"] = testErr
	cases["a@vodolaz095.ru"] = testErr
	cases["a@gmail.com"] = nil
	cases["b@gmail.com"] = nil
